...
/**
 * The MainMenu class represents the main activity of the Spotify Wrapped application. It provides
 * functionality for managing user authentication, displaying user information, navigating between
 * different fragments, and handling user interactions.
 */
public class MainMenu extends AppCompatActivity {
  ...
  /**
   * Called when the activity is first created. Initializes the activity, sets up the bottom
   * navigation view, and greets the user.
   *
  ...
  public void onActivityResult(int requestCode, int resultCode, Intent data) {
    ...
    if (WrappedFragment.AUTH_TOKEN_REQUEST_CODE == requestCode) {
      ...
      Toast.makeText(MainMenu.this, "Login Successfully!", Toast.LENGTH_SHORT).show();
