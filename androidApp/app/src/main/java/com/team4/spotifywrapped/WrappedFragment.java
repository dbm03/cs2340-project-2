...
public class WrappedFragment extends Fragment {
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    songRecommendationBtn.setOnClickListener((v) -> getSongRecommendations());

    recommendationsBtn.setOnClickListener((v) -> getArtistRecommendations());
  ...
  /**
   * Get code from Spotify. This method will open the Spotify login activity and get the code. What
   * is code? <a
   * href="https://developer.spotify.com/documentation/general/guides/authorization-guide/">...</a>
   */
  public void getCode() {
  ...
  public void getArtistRecommendations() {
    if (top5Artists_id.isEmpty()) {
      if (getContext() != null) {
        Toast.makeText(
                getContext(), "You need to get your top 5 artists first!", Toast.LENGTH_SHORT)
            .show();
      }
      return;
    }
