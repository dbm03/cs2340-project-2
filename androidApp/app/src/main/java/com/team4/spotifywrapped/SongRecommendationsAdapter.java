...
public class SongRecommendationsAdapter extends RecyclerView.Adapter<SongRecommendationsAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_song_recommendation, parent, false);
