...
public class PreviousWrappedSelectScreen extends AppCompatActivity
  ...
  private void redirectToWrapped(
    ...
    for (HashMap song : top5Songs) {
      // Each song looks like
      // {imageUrl=https://i.scdn.co/image/ab67616d0000b273f74a26b9b62a6a98e56a84e3, genre=Unknown
      // Genre, name=Personal, artistName=HRVY}
    ...
    for (HashMap artist : top5Artists) {
      // Each artist looks like
      // {imageUrl=https://i.scdn.co/image/ab6761610000e5ebe672b5f553298dcdccb0e676, popularity=100,
      // genre=pop, name=Taylor Swift}
