...
public class WrappedScreen1 extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    SpannableString boldSpan =
            new SpannableString("This is your Spotify Wrapped!");
    boldSpan.setSpan(
    ...
    private void nextwrappedscreen(ArrayList<WrappedScreen2> top5Songs, ArrayList<WrappedScreen3> top5Artists, String totalGenres, String top5Genres) {
